...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 512, .box_w = 28, .box_h = 34, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 119, .adv_w = 284, .box_w = 13, .box_h = 34, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 175, .adv_w = 441, .box_w = 25, .box_h = 34, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 282, .adv_w = 439, .box_w = 26, .box_h = 34, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 393, .adv_w = 514, .box_w = 30, .box_h = 34, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 521, .adv_w = 441, .box_w = 25, .box_h = 34, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 628, .adv_w = 474, .box_w = 26, .box_h = 34, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 739, .adv_w = 459, .box_w = 26, .box_h = 34, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 850, .adv_w = 495, .box_w = 27, .box_h = 34, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 965, .adv_w = 474, .box_w = 26, .box_h = 34, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1076, .adv_w = 555, .box_w = 31, .box_h = 34, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1208, .adv_w = 515, .box_w = 25, .box_h = 34, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 1315, .adv_w = 477, .box_w = 26, .box_h = 34, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1426, .adv_w = 607, .box_w = 29, .box_h = 34, .ofs_x = 5, .ofs_y = 0}
};
...
static const lv_font_fmt_txt_cmap_t cmaps[] =
{
    ...
    {
        .range_start = 67, .range_length = 19, .glyph_id_start = 11,
